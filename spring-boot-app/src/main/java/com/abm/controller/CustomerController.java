...
public class CustomerController {
	...
	public RegistrationStatus register(CustomerDetails customerDetails) {
		try {
			...
			customer.setPassword1(Base64.getEncoder().encodeToString(customerDetails.getPassword1().getBytes()));
			...
			try {
				...
				FileOutputStream os = new FileOutputStream("D:/Workspaces/Storage" + fileName);
